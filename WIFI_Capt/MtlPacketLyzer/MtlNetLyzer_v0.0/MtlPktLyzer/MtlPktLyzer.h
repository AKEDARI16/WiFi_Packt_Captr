...
void connect_parse_thread(void *);
void connect_thread_implement(char *, char *argv[], char *interface, pcap_t *);

void packet_capture_thread(void *);
void packet_parse_thread(void *);
void capture_thread_implement(char *, char *argv[], char *interface, pcap_t *);

void scan_capture_thread(void *);
//void scan_parse_thread(void *);
void scan_parse_thread(u_char *, const struct pcap_pkthdr *, const u_char *);
void scan_thread_implement(char *, char *argv[], char *interface, pcap_t *);

void handshake_capture_thread(void *);
void handshake_parse_thread(void *);
void handshake_thread_implement(char *, char *argv[], char *interface, pcap_t *);
...
struct PacketNode {
	...
	u_char packet[2048]; // Adjust the size as needed
};
