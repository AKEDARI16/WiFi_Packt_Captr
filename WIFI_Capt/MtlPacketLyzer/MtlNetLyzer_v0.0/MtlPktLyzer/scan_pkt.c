...
void scan_thread_implement(char *filter, char *argv[], char *interface, pcap_t *handle) {
    ...
    if (pthread_create(&capture_thread, NULL, (void* (*)(void*))bfill_fptr, (void *)handle) != 0 ||
        pthread_create(&parse_thread, NULL, (void* (*)(void*))bparse_fptr, (unsigned char *)&channel) != 0) {
